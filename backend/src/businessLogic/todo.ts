...
export async function getTodo(
  ...
  logger.info('Getting the todo for the user', {
    todoId: todoId,
    userId: userId
  })
...
export async function deleteTodo(
  ...
  logger.info('Deleting the todo for the user', {
    todoId: todoId,
    userId: userId
  })
...
export async function updateTodo(
  ...
  logger.info('Updating the todo for the user', {
    todoId: todoId,
    userId: userId
  })
...
export async function generateUploadUrl(
  ...
  logger.info('Generating the upload url for the todo of the user', {
    todoId: todoId,
    userId: userId
  })
